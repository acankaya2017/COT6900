...
Step 6 -
   ...
   c) add timer code and speed enhancements (saving results to hd, multi-threading, AI?, cloud?, doParallel?)
   d) AI enhancements (Posit?, ask AI to speed up my code?)
   e) library(doParallel) registerDoParallel(cores=4)
   f) allowWGCNAThreads(8) 
   g) other TODOs
```{r}
