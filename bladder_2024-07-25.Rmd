...
# geneList_up = ESM1 TROAP IQGAP3 ZNF695 TEDC2 UHRF1 ATP5MC1P4 RNASEH2A AL137060.3 FANCG C12orf76
# original paper's genes associated with tumor group = KIF20A UBE2C NUSAP1 TTK PBK TOP2A AURKB ASPM AURKA KIF14 
#   BUB1 NCAPG BUB1B CCNB1 CCNA2 TPX2 CCNB2 KIF4A CDC20 MELK

ego3_up <- gseGO(geneList  = geneList_up,
              OrgDb        = org.Hs.eg.db,
              ont          = "ALL",
              # minGSSize    = 100,
              # maxGSSize    = 500,
...
go_enrich <- enrichGO(gene = names(geneList_up),
                      universe = names(geneList_up),
                      OrgDb = org.Hs.eg.db, 
                      keyType = 'SYMBOL',
                      readable = T,
                      ont = "BP",
...
##### let us also look at GO Gene Set Enrichment Analysis (EA) of the down regulators

down_reg_genes = limma_res$topGenes[limma_res$topGenes$logFC < -1,]
View(down_reg_genes)
down_reg_genes_names = down_reg_genes[down_reg_genes$gene_name %in% relevant_gene_names,]$gene_name
down_reg_genes_logFC = down_reg_genes[down_reg_genes$gene_name %in% relevant_gene_names,]$logFC
geneList_down = down_reg_genes_logFC
names(geneList_down) = as.character(down_reg_genes_names)
geneList_down = sort(geneList_down, decreasing = TRUE)

# geneList_down = WEE1 CRY2 TIPARP WNT2B PER2 TP53INP2 THSD4 KLF4 LINC01346 AL669970.3 AL161457.1
#   LMX1A TPPP FBXL21P C5orf66-AS1 F10 AF001548.3 FAM135B CMTM5 LRRTM1 CFD CLEC3B NPAS4 OSTN 
#   AL354861.3 VSTM2A SGCG LRRC3B PMP2 XKR4 MYOC PI16
# original paper's genes associated with normal group = MPZ CDH19 LGI4 GPM6B CYP2U1 PLP1 SNCA COBL SNAP25 RELN

ego3_down<- gseGO(geneList  = geneList_down,
              OrgDb        = org.Hs.eg.db,
              ont          = "ALL",
              # minGSSize    = 100,
              # maxGSSize    = 500,
